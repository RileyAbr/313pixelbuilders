...
export class GamesComponent implements OnInit {
  ...
  {"name":"Skull & Crossbones","description":"Skull & Crossbones is a swashbuckling adventure. It has seven game levels. Once the first six levels are competed, the players go to the final level, the Wizardâ€™s Lair.", working: true},
  ...
  {"name":"Dragonâ€™s Lair","description":"Dragonâ€™s Lair is a laserdisc video game. In the game, the protagonist Dirk the Daring is a knight attempting to rescue Princess Daphne from the evil dragon Singe who has locked the princess in the foul wizard Mordrocâ€™s castle.", working: true},
  ...
  {"name":"Tron","description":"Tron consists of four sub-games based on events and characters in the movie, I\/O Tower, MCP Cone, Light Cycles, Battle Tanks. Players are trying to score points and advance through the gameâ€™s twelve levels by completing each of the sub-games.", working: true},
  {"name":"Pac-Man","description":"Pac-Man involves the titular character in an enclosed maze filled with dots or pellets. Players are going to consume all of the pellets while avoiding four multi-colored â€œghostsâ€ that wonder around the maze.", working: true},
  ...
  {"name":"Atari Star Wars","description":"Atari Star Wars puts the player inside an X-Wing Fighter craft travelling through space to shoot down enemy Tie-Fighters. Once the enemies are cleared the player arrives at the Death Star to shoot down Towers and turrets. The player is able to barrel down the Death Star's â€œtrenchâ€ to the gameâ€™s ultimate spectacular grand finale.", working: true},
  ...
  {"name":"Soul Calibur 3","description":"Soul Calibur 3 is a fighting video game. Soul Calibur is the holy sword created to battle the evil sword Soul Edge. Soul Calibur 3 features a full-fledged character creation system and numerous single-player game modes, such as story-based â€œTales of Soulsâ€ mode, the â€œChronicles of the Swordâ€ mode, and the endless â€œWorld Competitionâ€ mode.", working: true},
  {"name":"Mortal Kombat","description":"Mortal Kombat is an arcade fighting game. Players battle opponents in one-on-one matches. The fighter that completely drains the opponentâ€™s health bar first wins the round. ", working: true},
  {"name":"Mortal Kombat 2","description":"Mortal Kombat 2 is a fighting game, it is the second game in the Mortal Kombat. It introduces more varied finishing moves and several iconic characters. Matches are divided into rounds, and the first player to win two rounds by fully depleting their opponentâ€™s life bar is the winner.", working: true},
